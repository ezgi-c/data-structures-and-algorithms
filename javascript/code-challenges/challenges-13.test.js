...
// Solution code here...
  arr.indexOf(arr.find(str => str.length === Math.max(...arr.map(str => str.length))));
...
const standardizePhoneNumbers = (arr) =>
  // Solution code here...
  arr.map(str => str.substring(1,4) + str.substring(6,9) + str.substring(10,15));
...
const onlyOddChars = (str) =>
  // Solution code here...
  str.split('').filter(char => str.indexOf(char)%2 !== 0 ).join('');
...
const allHappy = (arr) =>
  // Solution code here...
  arr.length === arr.filter(str => str.includes(':)') ).length;
...
const findAnything = (arr, target) =>
  // Solution code here...
  arr.filter(str => str.includes(target));
...
const findEvery = (arr, target) =>
  // Solution code here...
  arr.length === arr.filter(str => str.includes(target)).length;
...
const unenrollBrook = (arr) =>
  // Solution code here...
  arr.map(subArr => subArr.filter(string => !string.includes('Brook')));
...
// found the above solution on https://www.tutorialspoint.com/ but could not get it to work
