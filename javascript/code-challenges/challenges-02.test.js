...
const addOne = (arr) => {
  // Solution code here...
  const newArr2 = arr.map(num => num = num + 1);
  return newArr2;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  const newArr3 = arr.map(string => string = string + '?');
  return newArr3;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  const newArr5 = [];
  arr.forEach(num => newArr5.push(Math.pow(2, num)) );
  return newArr5;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const newArr6 = arr.map(num => (Math.pow(2, num)) );
  return newArr6;
};
...
// return is not needed if the arrow function is one line; => acts as return
// got help from Manuch
