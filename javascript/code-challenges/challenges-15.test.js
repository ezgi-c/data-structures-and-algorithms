...
const detectTicTacToeWin = (board) => {
  // Solution code here...
  const helpCheckRow = (row) => row.every(val => val === row[0] && val !== '');
  const helpCheckCol = (col) => (board[0][col] === board[1][col] && board[0][col] === board[2][col] && board[1][col] === board[2][col]) && board.every(subArr => subArr[col] !== '');
  const helpCheckDiagonal = () =>((board[0][0] === board[1][1] && board[0][0] === board[2][2] && board[1][1] === board[2][2]) || (board[0][2] === board[1][1] && board[0][2] === board[2][0] && board[1][1] === board[2][0])) && board[1][1] !== '';

  return helpCheckRow(board[0]) || helpCheckRow(board[1]) || helpCheckRow(board[2]) || helpCheckCol(0) || helpCheckCol(1) || helpCheckCol(2) || helpCheckDiagonal();
};
